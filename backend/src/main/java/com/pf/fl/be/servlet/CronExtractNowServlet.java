...
public class CronExtractNowServlet extends HttpServlet {
    private static final Logger log = Logger.getLogger(CronExtractNowServlet.class.getSimpleName());
    private static final String TAG = CronExtractNowServlet.class.getSimpleName();
...
//                .payload("Adding task from CronExtractServlet: " + new java.util.Date().toString()));
    ...
    public void doExtract(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        FLOps1_Ext1_Extract extract = new FLOps1_Ext1_Extract(mEE, true, iwError);
        extract.doIt();
